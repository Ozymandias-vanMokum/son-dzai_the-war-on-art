...
import { WarOnArtStrategy, AuctionState, StrategyConfig } from './strategy.js';
...
const snipingConfig: StrategyConfig = {
  ...config,
  sniping: true,
  snipeWindow: 15,
};

const snipeState: AuctionState = {
  auctionId: 'test-005',
  currentPrice: 900,
  yourMaxBid: 1000,
...
const overpriceState: AuctionState = {
  auctionId: 'test-006',
  currentPrice: 1100,
  yourMaxBid: 1000,
  timeRemaining: 120,
